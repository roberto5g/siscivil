...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control {class}" tabindex="500">\n' +
                ...
                '  <input class="file-caption-name testa-campo" onkeydown="return false;" onpaste="return false;">\n' +
                '</div>';
        ...
        _setZoomContent: function ($frame, animate) {
            ...
            //inicializa o modal de detalhes full
            self._maximizeZoomDialog();
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgInvalidFileExtension: 'Extensão de arquivo inválida "{name}". Apenas arquivos com extensão "{extensions}" são suportados.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        dropZoneClickTitle: '<br>(ou click para selecionar o arquivo)',
    ...
    function removeDetalhes(previewId) {
        var id = previewId;
        //var el = document.querySelector('button.kv-file-zoom');
        $('#'+id).remove();

        //reseta o input que tiver arquivo invalido
        $('div.has-error').find('input').val('');
        //el.remove();
    }
